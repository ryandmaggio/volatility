...
2. To see available options, run "python3 vol.py -h" or "python3 vol.py --info"
...
3. To get more information on a Windows memory sample and to make sure Volatility
   supports that sample type, run 'python3 vol.py imageinfo -f <imagename>' or 'python3 vol.py kdbgscan -f <imagename>'

   Example:

    $ python3 vol.py imageinfo -f WIN-II7VOJTUNGL-20120324-193051.raw
    Volatility Foundation Volatility Framework 2.6
...
4. Run some other plugins. -f is a required option for all plugins. Some
   also require/accept other options. Run "python3 vol.py <plugin> -h" for

...
class AMD64PagedMemory(paged.AbstractWritablePagedMemory):
    ...
    def get_pml4e(self, vaddr):
        ...
        """
        pml4e_paddr = (self.dtb & 0xFFFFFFFFFF000) | (
    ...
    def get_pdpi(self, vaddr, pml4e):
        ...
        """
        pdpte_paddr = (pml4e & 0xFFFFFFFFFF000) | (
        ...
        for pml4e in range(0, 0x200):
            ...
            for pdpte in range(0, 0x200):
                ...
                for j in range(0, 0x200):
                    ...
                    if self.entry_present(entry) and self.page_size_flag(
                        entry
                    ):
                        if with_pte:
                        ...
                        for k in range(0, 0x200):
                            ...
                            if (
                                self.skip_duplicate_entries
                                and pt_entry == prev_pt_entry
                            ):
                                continue
...
class WindowsAMD64PagedMemory(AMD64PagedMemory):
    ...
    def is_valid_profile(self, profile):
        ...
        return (
            valid
            and profile.metadata.get('os', 'Unknown').lower() == 'windows'
        )

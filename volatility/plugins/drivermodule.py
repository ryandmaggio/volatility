...
class drivermodule(common.AbstractWindowsCommand):
    ...
    def calculate(self):
        ...
        if self._config.ADDR:
            ...
            if module_name:
                module_name = (
                    module_name.BaseDllName or module_name.FullDllName
                )
            ...
            for driver in drivers:
                if (
                    ...
                    driver_name = str(
                        driver.get_object_header().NameInfo.Name or ''
                    )
                    service_key = str(
                        driver.DriverExtension.ServiceKeyName or ''
                    )
            ...
            for driver in drivers:
                ...
                if owning_module:
                    module_name = (
                        owning_module.BaseDllName or owning_module.FullDllName
                    )
    ...
    def render_text(self, outfd, data):
        ...
        for module_name, driver_name, service_key, driver_name3 in data:
            self.table_row(
                outfd, module_name, driver_name, service_key, driver_name3
            )

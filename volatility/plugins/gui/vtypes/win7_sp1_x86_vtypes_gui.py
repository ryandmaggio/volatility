win32k_types = {
    ...
    'tagHOOK': [
        0x34,
        {
            ...
            'fLastHookHung': [
                48,
                ['BitField', {'end_bit': 8, 'start_bit': 7}],
            ],
    ...
    '__unnamed_179f': [
        0x4,
        {
            'pRgb256x3x16': [
                0,
                ['pointer', ['_D3DDDI_GAMMA_RAMP_RGB256x3x16']],
            ],
            'pRaw': [0, ['pointer', ['void']]],
    ...
    'tagDESKTOPINFO': [
        0x78,
        {
            ...
            'fIsDwmDesktop': [
                116,
                ['BitField', {'end_bit': 2, 'start_bit': 1}],
            ],
    ...
    'tagDISPLAYINFO': [
        0x64,
        {
            ...
            'fDesktopIsRect': [
                80,
                ['BitField', {'end_bit': 1, 'start_bit': 0}],
            ],
    ...
    'tagTHREADINFO': [
        0x208,
        {
            ...
            'ForceLegacyResizeNCMetr': [
                280,
                ['BitField', {'end_bit': 30, 'start_bit': 29}],
            ],
            'ptl': [180, ['pointer', ['_TL']]],
            'timeLast': [236, ['long']],
            'DontJournalAttach': [
                276,
                ['BitField', {'end_bit': 29, 'start_bit': 28}],
            ],
            'ppi': [184, ['pointer', ['tagPROCESSINFO']]],
            'SendMnuDblClk': [
                276,
                ['BitField', {'end_bit': 19, 'start_bit': 18}],
            ],
            'DDENoSync': [280, ['BitField', {'end_bit': 19, 'start_bit': 18}]],
            'EditNoMouseHide': [
                280,
                ['BitField', {'end_bit': 9, 'start_bit': 8}],
            ],
            'pDevHTInfo': [148, ['pointer', ['void']]],
            ...
            'NoDrawPatRect': [
                280,
                ['BitField', {'end_bit': 4, 'start_bit': 3}],
            ],
            'ForceTTGrapchis': [
                276,
                ['BitField', {'end_bit': 16, 'start_bit': 15}],
            ],
            'GetDeviceCaps': [
                276,
                ['BitField', {'end_bit': 21, 'start_bit': 20}],
            ],
            'pgdiBrushAttr': [16, ['pointer', ['void']]],
            'pq': [188, ['pointer', ['tagQ']]],
            'ulWindowSystemRendering': [172, ['unsigned long']],
            ...
            'NoSoftCursOnMoveSize': [
                280,
                ['BitField', {'end_bit': 32, 'start_bit': 31}],
            ],
            'psmsReceiveList': [232, ['pointer', ['tagSMS']]],
            'sphkCurrent': [304, ['pointer', ['tagHOOK']]],
            'No50ExStyles': [
                280,
                ['BitField', {'end_bit': 3, 'start_bit': 2}],
            ],
            'IgnoreFaults': [
                276,
                ['BitField', {'end_bit': 26, 'start_bit': 25}],
            ],
            ...
            'DealyHwndShakeChk': [
                276,
                ['BitField', {'end_bit': 12, 'start_bit': 11}],
            ],
            ...
            'StrictLLHook': [
                280,
                ['BitField', {'end_bit': 22, 'start_bit': 21}],
            ],
            'pdcoRender': [160, ['pointer', ['void']]],
            ...
            'CallTTDevice': [
                276,
                ['BitField', {'end_bit': 5, 'start_bit': 4}],
            ],
            ...
            'Win30AvgWidth': [
                276,
                ['BitField', {'end_bit': 20, 'start_bit': 19}],
            ],
            'ptlW32': [8, ['pointer', ['_TL']]],
            'AlwaysSendSyncPaint': [
                276,
                ['BitField', {'end_bit': 7, 'start_bit': 6}],
            ],
            'IgnoreNoDiscard': [
                276,
                ['BitField', {'end_bit': 1, 'start_bit': 0}],
            ...
            'NoTimeCbProtect': [
                280,
                ['BitField', {'end_bit': 25, 'start_bit': 24}],
            ],
            ...
            'SubtractClips': [
                276,
                ['BitField', {'end_bit': 15, 'start_bit': 14}],
            ],
            ...
            'MultipleBands': [
                276,
                ['BitField', {'end_bit': 6, 'start_bit': 5}],
            ],
            'Random31Ux': [
                276,
                ['BitField', {'end_bit': 28, 'start_bit': 27}],
            ],
            'HackWinFlags': [
                276,
                ['BitField', {'end_bit': 11, 'start_bit': 10}],
            ],
            ...
            'NoInitFlagsOnFocus': [
                280,
                ['BitField', {'end_bit': 18, 'start_bit': 17}],
            ],
            'ForceTextBand': [
                276,
                ['BitField', {'end_bit': 2, 'start_bit': 1}],
            ...
            'SpareCompatFlags2': [
                280,
                ['BitField', {'end_bit': 64, 'start_bit': 33}],
            ],
            'cWindows': [400, ['unsigned long']],
            'cEnterCount': [368, ['long']],
            'fETWReserved': [
                516,
                ['BitField', {'end_bit': 32, 'start_bit': 29}],
            ],
            'dwCompatFlags2': [280, ['unsigned long']],
            'NoEMFSpooling': [
                276,
                ['BitField', {'end_bit': 27, 'start_bit': 26}],
            ],
            'pMenuState': [260, ['pointer', ['tagMENUSTATE']]],
            'pRBRecursionCount': [40, ['unsigned long']],
            'SmoothScrolling': [
                276,
                ['BitField', {'end_bit': 31, 'start_bit': 30}],
            ],
            'iVisRgnUniqueness': [176, ['unsigned long']],
            'RefCount': [4, ['unsigned long']],
            'Win31DevModeSize': [
                276,
                ['BitField', {'end_bit': 24, 'start_bit': 23}],
            ],
            ...
            'NoCustomPaperSize': [
                280,
                ['BitField', {'end_bit': 13, 'start_bit': 12}],
            ],
            ...
            'TryExceptCallWndProc': [
                280,
                ['BitField', {'end_bit': 17, 'start_bit': 16}],
            ],
            'NcCalcSizeOnMove': [
                276,
                ['BitField', {'end_bit': 18, 'start_bit': 17}],
            ...
            'TTIgnoreRasterDupe': [
                276,
                ['BitField', {'end_bit': 10, 'start_bit': 9}],
            ],
            ...
            'NoWindowArrangement': [
                280,
                ['BitField', {'end_bit': 33, 'start_bit': 32}],
            ],
            'AnimationOff': [
                280,
                ['BitField', {'end_bit': 1, 'start_bit': 0}],
            ...
            'EnumTTNotDevice': [
                276,
                ['BitField', {'end_bit': 14, 'start_bit': 13}],
            ],
            ...
            'IncreaseStack': [
                276,
                ['BitField', {'end_bit': 23, 'start_bit': 22}],
            ],
        },
    ],
    '__unnamed_1262': [
    ...
    '_MOVESIZEDATA': [
        0xDC,
        {
            ...
            'fThresholdSelector': [
                160,
                ['BitField', {'end_bit': 18, 'start_bit': 15}],
            ],
            'MoveRectStyle': [
                180,
                [
    ...
    '_LARGE_UNICODE_STRING': [
        0xC,
        {
            ...
            'MaximumLength': [
                4,
                ['BitField', {'end_bit': 31, 'start_bit': 0}],
            ],
    ...
    'tagWND': [
        0xB0,
        {
            ...
            'FullScreenMode': [
                24,
                ['BitField', {'end_bit': 27, 'start_bit': 24}],
            ],
            'bLayeredInvalidate': [
                172,
                ['BitField', {'end_bit': 2, 'start_bit': 1}],
    ...
    'tagDESKTOP': [
        0x84,
        {
            ...
            'pMagInputTransform': [
                128,
                ['pointer', ['_MAGNIFICATION_INPUT_TRANSFORM']],
            ],
                ...
                [
                    'Enumeration',
                    {
                        ...
                        'choices': {
                            ...
                            8: 'WCA_FLIP3D_POLICY',
                            9: 'WCA_EXTENDED_FRAME_BOUNDS',
                            10: 'WCA_HAS_ICONIC_BITMAP',
                            11: 'WCA_THEME_ATTRIBUTES',
                            12: 'WCA_NCRENDERING_EXILED',
                            13: 'WCA_NCADORNMENTINFO',
                            14: 'WCA_EXCLUDED_FROM_LIVEPREVIEW',
                            15: 'WCA_VIDEO_OVERLAY_ACTIVE',
                            16: 'WCA_FORCE_ACTIVEWINDOW_APPEARANCE',
                            17: 'WCA_DISALLOW_PEEK',
                            18: 'WCA_LAST',
                        },
                    },
                ],

...
class XP2003x86BaseVTypes(obj.ProfileModification):
    ...
    def check(self, profile):
        ...
        return (
            m.get('os', None) == 'windows'
            and version < (6, 1)
            and m.get('memory_model', '32bit') == '32bit'
        )
        ...
        profile.vtypes.update(
            {
                        ...
                        'fmt': [
                            ...
                            [
                                ...
                                dict(
                                    ...
                                    choices=consts.CLIPBOARD_FORMAT_ENUM,
                                ),
                            ],
                        ],
                ...
                'tagHOOK': [
                    None,
                    {
                        ...
                        'flags': [
                            0x20,
                            ['Flags', {'bitmap': consts.HOOK_FLAGS}],
                        ],
                        'ihmod': [0x24, ['long']],
                        ...
                        'bType': [
                            ...
                            [
                                ...
                                dict(
                                    ...
                                    choices=consts.HANDLE_TYPE_ENUM,
                                ),
                            ],
                        ],
                ...
                '_LARGE_UNICODE_STRING': [
                    0xC,
                    {
                        ...
                        'MaximumLength': [
                            0x4,
                            ['BitField', dict(start_bit=0, end_bit=31)],
                        ],
                        'bAnsi': [
                            0x4,
                            ['BitField', dict(start_bit=31, end_bit=32)],
                        ],
                ...
                'tagTHREADINFO': [
                    None,
                    {
                        ...
                        'fsHooks': [
                            0x138,
                            ['unsigned long'],
                        ],  # xxxSetThreadDesktop, CheckWHFBits
                        'aphkStart': [
                            0x140,
                            ['array', 16, ['pointer64', ['tagHOOK']]],
                        ],
                    },
                ],
                'tagDESKTOPINFO': [
                    ...
                    0x60,
                    {
                        ...
                        'fLastHookHung': [
                            ...
                            [
                                'BitField',
                                dict(
                                    start_bit=7, end_bit=8, native_type='long'
                                ),
                            ],
                        ],
                    },

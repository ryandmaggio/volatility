...
class linux_check_evt_arm(linux_common.AbstractLinuxARMCommand):
    ...
    def calculate(self):
        ...
        swi = obj.Object(
            "unsigned int", offset=self.SWI_BASE, vm=self.addr_space
        )
        ...
        vector_swi_addr = obj.Object(
            "unsigned int", offset=self.SWI_BASE + (offset), vm=self.addr_space
        )
        ...
        while max_opcodes_to_check:
            opcode = obj.Object(
                "unsigned int", offset=vector_swi_addr, vm=self.addr_space
            )
    ...
    def render_text(self, outfd, data):
        self.table_header(
            outfd, [("Check", "<30"), ("PASS/FAIL", "<5"), ("Info", "<30")]
        )

        ...
        for proc in procs:
            ...
            for map in proc.get_proc_maps():
                ...
                while msg_idx != -1:
                    ...
                    time_idx = buffer[search_idx : search_idx + 200].find(
                        time_search
                    )
                    ...
                    if time_idx != -1:
                        time_end_idx = buffer[
                            search_idx + time_idx : search_idx + time_idx + 130
                        ].find(end_search)
                    ...
                    send_idx = buffer[
                        idx + search_idx : idx + search_idx + 200
                    ].find(send_search)

                    if send_idx != -1:
                        send_end_idx = buffer[
                            search_idx + send_idx : search_idx + send_idx + 60
                        ].find(end_search)

...
class _mac_hist_entry(obj.CType):
    ...
    def is_valid(self):
        ...
        if (
            ...
            or not self.obj_vm.is_valid_address(line_addr)
            or not self.obj_vm.is_valid_address(time_addr)
        ):
            return False
...
class MacBashTypes(obj.ProfileModification):
    ...
    def modification(self, profile):
        ...
        profile.object_classes.update(
            {
                "bash32_hist_entry": bash32_hist_entry,
                "bash64_hist_entry": bash64_hist_entry,
            }
        )

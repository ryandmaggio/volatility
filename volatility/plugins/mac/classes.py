...
class mac_kernel_classes(common.AbstractMacCommand):
    ...
    def calculate(self):
        ...
        dict_ptr_addr = common.get_cpp_sym(
            "sAllClassesDict", self.addr_space.profile
        )
        dict_addr = obj.Object(
            "unsigned long", offset=dict_ptr_addr, vm=self.addr_space
        )
        ...
        for ent in ents:
            ...
            osmeta = obj.Object(
                self._struct_or_class("OSMetaClass"),
                offset=ent.value.v(),
                vm=self.addr_space,
            )
            ...
            if hasattr(osmeta, "metaClass"):
                ...
                arr_start = obj.Object(
                    "Pointer", offset=osmeta.obj_offset, vm=self.addr_space
                )

            vptr = obj.Object(
                "unsigned long", offset=arr_start, vm=self.addr_space
            )
            while vptr != 0:

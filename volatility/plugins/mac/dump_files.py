...
class mac_dump_file(common.AbstractMacCommand):
    ...
    def __init__(self, config, *args, **kwargs):
        ...
        self._config.add_option(
            ...
            short_option='q',
            default=None,
            help='Virtual address of vnode structure from mac_list_files',
            action='store',
            type='int',
        )
        self._config.add_option(
    ...
    def calculate(self):
        ...
        if not vnode_off:
            debug.error(
                "You must specificy a vnode address (-q/--file-offset) from mac_list_files"
            )

...
profiles = [
    ...
    [
        ...
        18446743523963569392,
        18446743523964379136,
        1,
    ],
    [
        "MacHighSierra_10_13_1_17B25cx64",
        18446743523963490896,
        18446743523964391424,
        1,
    ],
    [
        "MacHighSierra_10_13_1_17B35ax64",
        18446743523963490832,
        18446743523964391424,
        1,
    ],
    [
    ...
    [
        ...
        18446743523959767128,
        18446743523956654080,
        0,
    ],
    [
        "MacSnowLeopard_10_6_4_AMDx64",
        18446743523959767504,
        18446743523956662272,
        0,
    ],
    [
        "MacSnowLeopard_10_6_5_AMDx64",
        18446743523959780720,
        18446743523956666368,
        0,
    ],
    [
    ...
    [
        ...
        18446743523959800160,
        18446743523956666368,
        0,
    ],
    [
        "MacSnowLeopard_10_6_8_AMDx64",
        18446743523959819016,
        18446743523956670464,
        0,
    ],
    [
        "MacSnowLeopard_10_6_10_6_1_AMDx64",
        18446743523959762264,
        18446743523956649984,
        0,
    ],
    ...
    [
        ...
        18446743523961328192,
        18446743523962269696,
        1,
    ],
    [
        "MacMountainLion_10_8_2_12c54_12c60x64",
        18446743523961340528,
        18446743523962269696,
        1,
    ],
    [
    ...
    [
        ...
        18446743523961302256,
        18446743523962269696,
        1,
    ],
    [
        "MacMountainLion_10_8_5_12F2518_AMDx64",
        18446743523961347136,
        18446743523962273792,
        1,
    ],
    [
    ...
    [
        ...
        18446743523961749984,
        18446743523962273792,
        1,
    ],
    [
        "MacMavericks_10_9_2_13C1021_AMDx64",
        18446743523961751392,
        18446743523962273792,
        1,
    ],
    [
        "MacMavericks_10_9_2_13c64x64",
        18446743523961753424,
        18446743523962273792,
        1,
    ],
    [
        "MacMavericks_10_9_3_13d65x64",
        18446743523961765744,
        18446743523962273792,
        1,
    ],
    [
        "MacMavericks_10_9_4_13e28x64",
        18446743523961767008,
        18446743523962273792,
        1,
    ],
    [
        "MacMavericks_10_9_5_13F1911_AMDx64",
        18446743523961774096,
        18446743523962273792,
        1,
    ],
    [
        "MacMavericks_10_9_5_13f34x64",
        18446743523961765968,
        18446743523962273792,
        1,
    ],
    [
        "MacMavericks_10_9_13F1077x64",
        18446743523961774256,
        18446743523962273792,
        1,
    ],
]
...
class mac_get_profile(common.AbstractMacCommand):
        ...
        if ver_buf and ver_buf.startswith(sig):
            ...
            for collision_set in collision_sets:
                ...
                if profile in collision_set:
                    ...
                    for test_profile, test_string in list(
                        collision_set.items()
                    ):
    ...
    def calculate(self):
        ...
        if result:
            ...
            debug.error(
                "Unable to find an OS X profile for the given memory sample."
            )

    def unified_output(self, data):
        return TreeGrid(
            [("Profile", str), ("Shift Address", Address)],
            self.generator(data),
        )
    ...
    def render_text(self, outfd, data):
        self.table_header(
            outfd, [("Profile", "50"), ("Shift Address", "[addrpad]")]
        )

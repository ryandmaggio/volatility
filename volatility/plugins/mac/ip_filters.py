...
class mac_ip_filters(lsmod.mac_lsmod):
    ...
    def calculate(self):
        ...
        for list_addr in list_addrs:
            plist = obj.Object(
                "ipfilter_list", offset=list_addr, vm=self.addr_space
            )

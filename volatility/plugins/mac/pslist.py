...
class mac_pslist(common.AbstractMacCommand):
    ...
    def __init__(self, config, *args, **kwargs):
        ...
        self._config.add_option(
            ...
            short_option='T',
            default=None,
            help='Operate on this process (virtual address from mac_psxview)',
            action='store',
            type='str',
        )
    ...
    def allprocs(self):
        ...
        proc = obj.Object(
            "proc", offset=procsaddr.lh_first, vm=self.addr_space
        )
        seen = []
    ...
    def calculate(self):
        ...
        if self._config.TASK:
            ...
            try:
                ...
                debug.error(
                    "Invalid task address given. Must be address in hex."
                )

...
class String(obj.BaseObject):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        obj.BaseObject.__init__(
            self, theType, offset, vm, parent=parent, profile=profile, **kwargs
        )
    ...
    def __unicode__(self):
        ...
        """
        return (
            self.v().decode(self.encoding, 'replace').split("\x00", 1)[0] or ''
        )
...
class Flags(obj.NativeType):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.target_obj = obj.Object(
            target, offset=offset, vm=vm, parent=parent
        )
...
class IpAddress(obj.NativeType):
    ...
    def __init__(self, theType, offset, vm, **kwargs):
        obj.NativeType.__init__(
            self, theType, offset, vm, format_string="4s", **kwargs
        )
...
class Ipv6Address(obj.NativeType):
    ...
    def __init__(self, theType, offset, vm, **kwargs):
        obj.NativeType.__init__(
            self, theType, offset, vm, format_string="16s", **kwargs
        )
...
class VolatilityDTB(obj.VolatilityMagic):
    def generate_suggestions(self):
        ...
        last_range_start, last_range_size = sorted(

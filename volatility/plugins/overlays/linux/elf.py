...
class elf_hdr(elf):
    ...
    def program_headers(self):
        ...
        for i in range(phnum):
            ...
            phdr = obj.Object(
                "elf_phdr", offset=arr_start + idx, vm=self.obj_vm, parent=self
            )
            if phdr.is_valid():
                yield phdr
    ...
    def section_headers(self):
        ...
        for i in range(self.e_shnum):
            ...
            shdr = obj.Object(
                "elf_shdr", offset=arr_start + idx, vm=self.obj_vm, parent=self
            )
            if shdr.is_valid():
                yield shdr
    ...
    def relocations(self):
        for phdr in self.program_headers():
            ...
            for idx in range(count + 24):
                ...
                reloc = obj.Object(
                    struct_name, offset=offset, vm=self.obj_vm, parent=self
                )
...
class elf_phdr(elf):
    ...
    def dynamic_sections(self):
        ...
        for i in range(256):
            ...
            dyn = obj.Object(
                tname, offset=arr_start + idx, vm=self.obj_vm, parent=self
            )
...
class elf_note(elf):
    ...
    def cast_descsz(self, obj_type):
        ...
        return obj.Object(
            obj_type, offset=desc_offset, vm=self.obj_vm, parent=self
        )

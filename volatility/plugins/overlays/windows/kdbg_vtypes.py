...
class _KDDEBUGGER_DATA64(obj.CType):
    ...
    def ServicePack(self):
        ...
        """
        csdresult = obj.Object(
            "unsigned long", offset=self.CmNtCSDVersion, vm=self.obj_native_vm
        )
    ...
    def processes(self):
        ...
        if not list_head:
            raise AttributeError(
                "Could not list tasks, please verify your --profile with kdbgscan"
            )
    ...
    def modules(self):
        ...
        if not list_head:
            raise AttributeError(
                "Could not list modules, please verify your --profile with kdbgscan"
            )
    ...
    def dbgkd_find_version64(self, pages_to_scan):
        ...
        memory_model = self.obj_native_vm.profile.metadata.get(
            'memory_model', '32bit'
        )
        ...
        dbgkd_size = self.obj_native_vm.profile.get_obj_size(
        ...
        while dbgkd_off <= (dbgkd_end - dbgkd_size):
            ...
            dbgkd = obj.Object(
                "_DBGKD_GET_VERSION64", offset=dbgkd_off, vm=self.obj_native_vm
            )
    ...
    def kpcrs(self):
        ...
        if (
            self.obj_native_vm.profile.metadata.get('memory_model', '32bit')
            == '32bit'
        ):
        ...
        for p in cpu_array:
            ...
            kpcr = obj.Object(
                ...
                - self.obj_native_vm.profile.get_obj_offset(
                    "_KPCR", prcb_member
                ),
                        ...
                        'MmUnloadedDrivers': [
                            ...
                            [
                                ...
                                [
                                    ...
                                    [
                                        'array',
                                        lambda x: x.MmLastUnloadedDriver.dereference(),
                                        ['_UNLOADED_DRIVER'],
                                    ],
                                ],
                            ],

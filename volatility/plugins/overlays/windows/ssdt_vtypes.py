...
def syscalls_property(x):
    debug.debug(
        "Deprecation warning: Please use profile.additional['syscalls'] over profile.syscalls"
    )
...
class Win2003SP0Syscalls(AbstractSyscalls):
    ...
    syscall_module = (
        'volatility.plugins.overlays.windows.win2003_sp0_x86_syscalls'
    )
    conditions = {
        'os': lambda x: x == 'windows',
        'memory_model': lambda x: x == '32bit',
...
class Win2003SP12Syscalls(AbstractSyscalls):
    syscall_module = (
        'volatility.plugins.overlays.windows.win2003_sp12_x86_syscalls'
    )
    conditions = {
        'os': lambda x: x == 'windows',
        'memory_model': lambda x: x == '32bit',
...
class Win2003SP12x64Syscalls(AbstractSyscalls):
    syscall_module = (
        'volatility.plugins.overlays.windows.win2003_sp12_x64_syscalls'
    )
    conditions = {
        'os': lambda x: x == 'windows',
        'memory_model': lambda x: x == '64bit',
...
class VistaSP0Syscalls(AbstractSyscalls):
    syscall_module = (
        'volatility.plugins.overlays.windows.vista_sp0_x86_syscalls'
    )
    conditions = {
        'os': lambda x: x == 'windows',
        'memory_model': lambda x: x == '32bit',
...
class VistaSP0x64Syscalls(AbstractSyscalls):
    syscall_module = (
        'volatility.plugins.overlays.windows.vista_sp0_x64_syscalls'
    )
    conditions = {
        'os': lambda x: x == 'windows',
        'memory_model': lambda x: x == '64bit',
...
class VistaSP12Syscalls(AbstractSyscalls):
    syscall_module = (
        'volatility.plugins.overlays.windows.vista_sp12_x86_syscalls'
    )
    conditions = {
        'os': lambda x: x == 'windows',
        'memory_model': lambda x: x == '32bit',
...
class VistaSP12x64Syscalls(AbstractSyscalls):
    syscall_module = (
        'volatility.plugins.overlays.windows.vista_sp12_x64_syscalls'
    )
    conditions = {
        'os': lambda x: x == 'windows',
        'memory_model': lambda x: x == '64bit',
...
class Win7SP01Syscalls(AbstractSyscalls):
    syscall_module = (
        'volatility.plugins.overlays.windows.win7_sp01_x86_syscalls'
    )
    conditions = {
        'os': lambda x: x == 'windows',
        'memory_model': lambda x: x == '32bit',
...
class Win7SP01x64Syscalls(AbstractSyscalls):
    syscall_module = (
        'volatility.plugins.overlays.windows.win7_sp01_x64_syscalls'
    )
    conditions = {
        'os': lambda x: x == 'windows',
        'memory_model': lambda x: x == '64bit',
...
class Win8SP0x64Syscalls(AbstractSyscalls):
    syscall_module = (
        'volatility.plugins.overlays.windows.win8_sp0_x64_syscalls'
    )
    conditions = {
        'os': lambda x: x == 'windows',
        'memory_model': lambda x: x == '64bit',
...
class Win8SP0x86Syscalls(AbstractSyscalls):
    syscall_module = (
        'volatility.plugins.overlays.windows.win8_sp0_x86_syscalls'
    )
    conditions = {
        'os': lambda x: x == 'windows',
        'memory_model': lambda x: x == '32bit',
...
class Win8SP1x86Syscalls(AbstractSyscalls):
    syscall_module = (
        'volatility.plugins.overlays.windows.win8_sp1_x86_syscalls'
    )
    conditions = {
        'os': lambda x: x == 'windows',
        'memory_model': lambda x: x == '32bit',
...
class Win8SP1x64Syscalls(AbstractSyscalls):
    syscall_module = (
        'volatility.plugins.overlays.windows.win8_sp1_x64_syscalls'
    )
    conditions = {
        'os': lambda x: x == 'windows',
        'memory_model': lambda x: x == '64bit',
...
class Win10x64_10586_Syscalls(AbstractSyscalls):
    syscall_module = (
        'volatility.plugins.overlays.windows.win10_x64_10586_syscalls'
    )
    conditions = {
        'os': lambda x: x == 'windows',
        'memory_model': lambda x: x == '64bit',
...
class Win10x86_10586_Syscalls(AbstractSyscalls):
    syscall_module = (
        'volatility.plugins.overlays.windows.win10_x86_10586_syscalls'
    )
    conditions = {
        'os': lambda x: x == 'windows',
        'memory_model': lambda x: x == '32bit',
...
class Win10x64_14393_Syscalls(AbstractSyscalls):
    syscall_module = (
        'volatility.plugins.overlays.windows.win10_x64_14393_syscalls'
    )
    conditions = {
        'os': lambda x: x == 'windows',
        'memory_model': lambda x: x == '64bit',
...
class Win10x86_14393_Syscalls(AbstractSyscalls):
    syscall_module = (
        'volatility.plugins.overlays.windows.win10_x86_14393_syscalls'
    )
    conditions = {
        'os': lambda x: x == 'windows',
        'memory_model': lambda x: x == '32bit',
...
class Win10x64_15063_Syscalls(AbstractSyscalls):
    syscall_module = (
        'volatility.plugins.overlays.windows.win10_x64_15063_syscalls'
    )
    conditions = {
        'os': lambda x: x == 'windows',
        'memory_model': lambda x: x == '64bit',
...
class Win10x86_15063_Syscalls(AbstractSyscalls):
    syscall_module = (
        'volatility.plugins.overlays.windows.win10_x86_15063_syscalls'
    )
    conditions = {
        'os': lambda x: x == 'windows',
        'memory_model': lambda x: x == '32bit',
...
class Win10x64_16299_Syscalls(AbstractSyscalls):
    syscall_module = (
        'volatility.plugins.overlays.windows.win10_x64_16299_syscalls'
    )
    conditions = {
        'os': lambda x: x == 'windows',
        'memory_model': lambda x: x == '64bit',
...
class Win10x86_16299_Syscalls(AbstractSyscalls):
    syscall_module = (
        'volatility.plugins.overlays.windows.win10_x86_16299_syscalls'
    )
    conditions = {
        'os': lambda x: x == 'windows',
        'memory_model': lambda x: x == '32bit',

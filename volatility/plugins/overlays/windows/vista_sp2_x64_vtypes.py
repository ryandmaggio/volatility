ntkrnlmp_types = {
    ...
    '_WHEA_GENERIC_PROCESSOR_ERROR_VALIDBITS': [
        0x8,
        {
            'ProcessorType': [
                0x0,
            ...
            'RawDataFormat': [
                ...
                [
                    ...
                    dict(
                        target='long',
                        choices={
                            0: 'WheaRawDataFormatIPFSalRecord',
                            1: 'WheaRawDataFormatIA32MCA',
                            2: 'WheaRawDataFormatIntel64MCA',
                            3: 'WheaRawDataFormatAMD64MCA',
                            4: 'WheaRawDataFormatMemory',
                            5: 'WheaRawDataFormatPCIExpress',
                            6: 'WheaRawDataFormatNMIPort',
                            7: 'WheaRawDataFormatPCIXBus',
                            8: 'WheaRawDataFormatPCIXDevice',
                            9: 'WheaRawDataFormatGeneric',
                            10: 'WheaRawDataFormatMax',
                        },
                    ),
                ],
            ],
    ...
    '_CONTROL_AREA': [
        0x70,
        {
            ...
            'WaitingForDeletion': [
                0x50,
                ['pointer64', ['_MI_SECTION_CREATION_GATE']],
            ],
        ...
        0x1828,
        {
            ...
            'SpareSameTebBits': [
                ...
                [
                    'BitField',
                    dict(
                        start_bit=10, end_bit=16, native_type='unsigned short'
                    ),
                ],
            ],
    ...
    '_WHEA_PCIXDEVICE_ERROR': [
        0x68,
        {
            ...
            'RegisterDataPairs': [
                0x28,
                ['array', 4, ['WHEA_PCIXDEVICE_REGISTER_PAIR']],
            ],
        },
    ],
    '_MMWSLE_HASH': [
        ...
        0x100,
        {
            ...
            'DelayedCloseIndex': [
                ...
                [
                    'BitField',
                    dict(
                        start_bit=11, end_bit=22, native_type='unsigned long'
                    ),
                ],
            ],
            'TotalLevels': [
    ...
    '_ALPC_COMPLETION_PACKET_LOOKASIDE': [
        0x38,
        {
            ...
            'Entry': [
                0x38,
                ['array', 0, ['_ALPC_COMPLETION_PACKET_LOOKASIDE_ENTRY']],
            ],
        },
    ],
    '_TERMINATION_PORT': [
    ...
    '_WHEA_PCIXDEVICE_ERROR_VALIDBITS': [
        0x8,
        {
            'ErrorStatus': [
                0x0,
            ...
            'PortType': [
                ...
                [
                    ...
                    dict(
                        target='long',
                        choices={
                            0: 'WheaPciExpressEndpoint',
                            1: 'WheaPciExpressLegacyEndpoint',
                            4: 'WheaPciExpressRootPort',
                            5: 'WheaPciExpressUpstreamSwitchPort',
                            6: 'WheaPciExpressDownstreamSwitchPort',
                            7: 'WheaPciExpressToPciXBridge',
                            8: 'WheaPciXToExpressBridge',
                            9: 'WheaPciExpressRootComplexIntegratedEndpoint',
                            10: 'WheaPciExpressRootComplexEventCollector',
                        },
                    ),
                ],
            ],
    ...
    '_WHEA_PCIEXPRESS_COMMAND_STATUS': [
        0x4,
        {

ntkrnlmp_types = {
        ...
        0x348,
        {
            ...
            'EtwStackTraceApcInserted': [
                ...
                [
                    'BitField',
                    dict(
                        start_bit=14, end_bit=22, native_type='unsigned long'
                    ),
                ],
            ],
            'ReservedFlags': [
    ...
    '_KPROCESS': [
        0x2C8,
        {
            ...
            'ActiveGroupsMask': [
                ...
                [
                    'BitField',
                    dict(start_bit=6, end_bit=26, native_type='unsigned long'),
                ],
            ],
            'ReservedFlags': [
                0x1B0,
                [
                    'BitField',
                    dict(start_bit=26, end_bit=32, native_type='long'),
                ],
            ],
        ...
        0x10,
        {
            ...
            'Unused': [
                ...
                [
                    'BitField',
                    dict(
                        start_bit=16, end_bit=29, native_type='unsigned long'
                    ),
                ],
            ],
            'BitMap': [
        ...
        0x4A8,
        {
            ...
            'SpareJobFlags': [
                ...
                [
                    'BitField',
                    dict(
                        start_bit=23, end_bit=32, native_type='unsigned long'
                    ),
                ],
            ],
    ...
    '_PROCESSOR_POWER_STATE': [
        0x1C8,
        {
            ...
            'PlatformIdleAccounting': [
                0x10,
                ['pointer64', ['_PLATFORM_IDLE_ACCOUNTING']],
            ],
    ...
    '__unnamed_207b': [
        0x8,
        {
            ...
            'ProviderReservation': [
                0x0,
                ['pointer64', ['_PNP_RESERVED_PROVIDER_INFO']],
            ],
        },
    ],
    '_PNP_PROVIDER_INFO': [
    ...
    '_ETW_GUID_ENTRY': [
        0x178,
        {
            ...
            'FilterData': [
                0x170,
                ['pointer64', ['pointer64', ['_EVENT_FILTER_HEADER']]],
            ],
        },
    ],
    ...
    '_MMSECURE_FLAGS': [
        0x4,
        {
            ...
            'Spare': [
                ...
                [
                    'BitField',
                    dict(start_bit=3, end_bit=12, native_type='unsigned long'),
                ],
            ],
        },
    ],

ntkrpamp_types = {
        ...
        0x4,
        {
            ...
            'TbFlushStamp': [
                ...
                [
                    'BitField',
                    dict(
                        start_bit=25, end_bit=29, native_type='unsigned long'
                    ),
                ],
            ],
            'SpareBlink': [
        ...
        0x4,
        {
            ...
            'PageIdentity': [
                ...
                [
                    'BitField',
                    dict(
                        start_bit=25, end_bit=27, native_type='unsigned long'
                    ),
                ],
            ],
            'PrototypePte': [
    ...
    '_PROCESSOR_POWER_STATE': [
        0x180,
        {
            ...
            'PlatformIdleAccounting': [
                0x8,
                ['pointer', ['_PLATFORM_IDLE_ACCOUNTING']],
            ],
    ...
    '__unnamed_204c': [
        0x4,
        {
            ...
            'ProviderReservation': [
                0x0,
                ['pointer', ['_PNP_RESERVED_PROVIDER_INFO']],
            ],
        },
    ],
    '_PNP_PROVIDER_INFO': [
    ...
    '_ETW_GUID_ENTRY': [
        0x160,
        {
            ...
            'FilterData': [
                0x158,
                ['pointer', ['pointer', ['_EVENT_FILTER_HEADER']]],
            ],
        },
    ],
    '_DEFERRED_WRITE': [
